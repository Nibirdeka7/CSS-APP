...
const MatchCreateModal = ({ open, onOpenChange, onSuccess }) => {
  const { events, fetchEligibleTeams, createMatch, isLoading } =
    useAdminStore();
  ...
  useEffect(() => {
    if (formData.event) {
      fetchEligibleTeams(formData.event).then((teams) =>
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="space-y-1">
              ...
              <Select
                ...
                onValueChange={(val) =>
                  setFormData({ ...formData, teamA: val })
                }
              >
            ...
            <div className="space-y-1">
              ...
              <Select
                disabled={!formData.event}
                onValueChange={(val) =>
                  setFormData({ ...formData, teamB: val })
                }
              >
                <SelectTrigger className="bg-gray-50">
